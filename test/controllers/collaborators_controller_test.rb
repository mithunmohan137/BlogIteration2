...
class CollaboratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collaborator" do
    assert_difference('Collaborator.count') do
      post collaborators_url, params: { collaborator: { post_id: @collaborator.post_id, user_id: @collaborator.user_id } }
    end
  ...
  test "should update collaborator" do
    patch collaborator_url(@collaborator), params: { collaborator: { post_id: @collaborator.post_id, user_id: @collaborator.user_id } }
